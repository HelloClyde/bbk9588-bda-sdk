#ifndef BDA_RESEARCH_SDK_H
#define BDA_RESEARCH_SDK_H

/*
 * Reverse-engineering only. Entries in this header include unverified ABI and
 * lifecycle guesses. Developer applications must include sdk/include/bda_sdk.h.
 */
