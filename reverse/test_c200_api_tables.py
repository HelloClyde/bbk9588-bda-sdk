...
class C200ApiTablesTest(unittest.TestCase):
    def test_named_sdk_offsets_resolve_inside_c200_when_firmware_exists(self) -> None:
        ...
        self.assertEqual(by_name["BDA_GUI_WINDOW_TIMER_START_LIKE"]["target_va"], 0x800DE150)
        self.assertEqual(by_name["BDA_GUI_WINDOW_TIMER_STOP_LIKE"]["target_va"], 0x800DE190)
        self.assertEqual(by_name["BDA_GUI_WINDOW_TIMER_EXISTS_LIKE"]["target_va"], 0x800DE0A8)
        self.assertEqual(by_name["BDA_GUI_WINDOW_TIMER_SET_PERIOD_LIKE"]["target_va"], 0x800DE1C8)
        self.assertEqual(by_name["BDA_GUI_WINDOW_TIMER_CLOCK_MS_LIKE"]["target_va"], 0x800DE144)
        ...
        self.assertEqual(by_name["BDA_SYS_AUDIO_ATTENUATION_SET_LIKE"]["target_va"], 0x8018921C)
        self.assertEqual(by_name["BDA_SYS_AUDIO_ATTENUATION_GET_LIKE"]["target_va"], 0x80189248)
