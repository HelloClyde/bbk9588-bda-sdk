...
NOTES: dict[tuple[str, int], str] = {
    ...
    ("GUI", 0x310): "compatible draw context create；C200 分配 0xd4 byte context 并复制 source context 的 drawable bounds/backend。",
    ("GUI", 0x314): "surface/canvas flush 并释放 context；C200 调 backend +0x34 后释放 object。",
    ...
    ("GUI", 0x418): "双 context/双矩形 render helper；C200 使用 stack+0x14 的第二 context 并调用 backend +0x94。",
