...
static const char k_log_path_a[] =
    "A:\\\xd3\xa6\xd3\xc3\\\xca\xfd\xbe\xdd\\\xd3\xce\xcf\xb7\\GAMEG20.TXT";
static const char k_log_path_root[] =
    "\\\xd3\xa6\xd3\xc3\\\xca\xfd\xbe\xdd\\\xd3\xce\xcf\xb7\\GAMEG20.TXT";
static const char k_window_title[] = "GFXV20";
...
static void draw_static_scene(void) {
    ...
    (void)bda_gui_draw_text_like(g_draw, 38, 8, "COLOR KEY SPRITE V20", -1);
    (void)bda_gui_draw_text_like(g_draw, 38, 55, "MAGENTA KEY 0xF81F", -1);
    ...
    (void)bda_gui_draw_text_like(
        ...
        35,
        205,
        g_animation_complete ? "240 FRAMES COMPLETE" : "TRANSPARENT SPRITE",
        -1
    );
    (void)bda_gui_set_text_color_like(g_draw, foreground);
...
int bda_main(void) {
    ...
    reset_log();
    log_text("START COLOR KEY SPRITE PROBE V20");
    ...
    log_text("END COLOR KEY SPRITE PROBE V20");
