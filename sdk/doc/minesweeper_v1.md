...
源码：`sdk/api/examples/minesweeper_bda.c`

构建产物：`build/MinesweeperV1.bda`
...
`sdk/assets/minesweeper_icon.png`，打包器会生成固件需要的两个 `80x80` 图标，以及
...
![Minesweeper menu icon](../assets/minesweeper_icon.png)
