    ...
    def _build_snapshot_locked(self, *, detail: str = "compact") -> dict[str, object]:
        ...
        snapshot = {
            ...
            "accelerators": {
                ...
                "surface_gui_putpixel": getattr(self.emu, "surface_gui_putpixel_accel_count", 0),
                "surface_gui_putpixel_cache_hits": getattr(self.emu, "surface_gui_putpixel_cache_hits", 0),
                "surface_gui_putpixel_cache_misses": getattr(self.emu, "surface_gui_putpixel_cache_misses", 0),
                "surface_gui_putpixel_cache_size": len(getattr(self.emu, "surface_gui_putpixel_cache", {}) or {}),
                "surface_gui_palette": getattr(self.emu, "surface_gui_palette_accel_count", 0),
