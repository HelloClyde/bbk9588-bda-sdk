...
REQUIRED_COMMON = (
    ...
    "emu/tools/make_combined_nand.py",
    "emu/tools/make_fat16_image.py",
    "emu/tools/stamp_ftl_oob.py",
    "emu/web/frontend.py",
...
FORBIDDEN_RUNTIME_FILES = (
    ...
    "emu/qemu/README.md",
    "emu/tools/collect_qemu_runtime.ps1",
...
def _is_binary_allowed(name: str) -> bool:
    lower = name.lower()
    return lower.startswith(ALLOWED_RUNTIME_BINARY_PREFIXES)
